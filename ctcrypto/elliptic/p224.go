...
func initP224() {
	...
	p224.P, _ = modFromString("26959946667150639794667015087019630673557916260026308143510066298881", 10)
	p224.N, _ = modFromString("26959946667150639794667015087019625940457807714424391721682722368061", 10)
	p224.B, _ = fromString("b4050a850c04b3abf54132565044b0b7d7bfd8ba270b39432355ffb4", 16)
	p224.Gx, _ = fromString("b70e0cbd6bb4bf7f321390b94a03c1d356c21122343280d6115c1d21", 16)
	p224.Gy, _ = fromString("bd376388b5f723fb4c22dfe6cd4375a05a07476444d5819985007e34", 16)
	p224.BitSize = 224

	p224FromBig(&p224.gx, new(big.Int).SetBytes(p224.Gx.Bytes()))
	p224FromBig(&p224.gy, new(big.Int).SetBytes(p224.Gy.Bytes()))
	p224FromBig(&p224.b, new(big.Int).SetBytes(p224.B.Bytes()))
}
