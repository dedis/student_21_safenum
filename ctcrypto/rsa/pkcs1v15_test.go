...
func TestEncryptPKCS1v15(t *testing.T) {
	random := rand.Reader
	k := int((rsaPrivateKey.N.BitLen() + 7) / 8)
...
var rsaPrivateKey = &PrivateKey{
	PublicKey: PublicKey{
		N: fromBase10Mod("9353930466774385905609975137998169297361893554149986716853295022578535724979677252958524466350471210367835187480748268864277464700638583474144061408845077"),
		E: 65537,
	},
...
func TestShortPKCS1v15Signature(t *testing.T) {
	pub := &PublicKey{
		E: 65537,
		N: fromBase10Mod("8272693557323587081220342447407965471608219912416565371060697606400726784709760494166080686904546560026343451112103559482851304715739629410219358933351333"),
	}
